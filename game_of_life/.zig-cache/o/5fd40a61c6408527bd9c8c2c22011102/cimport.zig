...
pub const struct_Vector2 = extern struct {
    ...
    pub const DrawCircleLinesEx = __root.DrawCircleLinesEx;
...
pub const struct_Image = extern struct {
    ...
    pub const ImageDrawLineStrip = __root.ImageDrawLineStrip;
    ...
    pub const ImageDrawRectanglePro = __root.ImageDrawRectanglePro;
    ...
    pub const ImageDrawRectangleGradientEx = __root.ImageDrawRectangleGradientEx;
    ...
    pub const ImageDrawCircleGradient = __root.ImageDrawCircleGradient;
    pub const ImageDrawImage = __root.ImageDrawImage;
    pub const ImageDrawImageEx = __root.ImageDrawImageEx;
    pub const ImageDrawImageRec = __root.ImageDrawImageRec;
    pub const ImageDrawImagePro = __root.ImageDrawImagePro;
    pub const ImageDrawText = __root.ImageDrawText;
    pub const ImageDrawTextEx = __root.ImageDrawTextEx;
    pub const ImageDrawTextPro = __root.ImageDrawTextPro;
...
pub const TraceLogCallback = ?*const fn (logLevel: c_int, text: [*c]const u8, args: va_list) callconv(.c) void;
...
pub extern fn ChangeDirectory(dirPath: [*c]const u8) c_int;
...
pub extern fn SetShapesTexture(texture: Texture2D, rec: Rectangle) void;
...
pub extern fn DrawRectangleLinesEx(rec: Rectangle, thick: f32, color: Color) void;
...
pub extern fn DrawRectangleRoundedLinesEx(rec: Rectangle, roundness: f32, segments: c_int, thick: f32, color: Color) void;
...
pub extern fn DrawPolyLinesEx(center: Vector2, sides: c_int, radius: f32, rotation: f32, thick: f32, color: Color) void;
...
pub extern fn ImageDrawImage(dst: [*c]Image, src: Image, posX: c_int, posY: c_int, tint: Color) void;
...
pub extern fn DrawTextureRec(texture: Texture2D, rec: Rectangle, position: Vector2, tint: Color) void;
pub extern fn DrawTexturePro(texture: Texture2D, srcrec: Rectangle, dstrec: Rectangle, origin: Vector2, rotation: f32, tint: Color) void;
pub extern fn DrawTextureNPatch(texture: Texture2D, nPatchInfo: NPatchInfo, dstrec: Rectangle, origin: Vector2, rotation: f32, tint: Color) void;
...
pub extern fn DrawCylinder(position: Vector3, radiusTop: f32, radiusBottom: f32, height: f32, sides: c_int, color: Color) void;
pub extern fn DrawCylinderEx(startPos: Vector3, endPos: Vector3, startRadius: f32, endRadius: f32, sides: c_int, color: Color) void;
pub extern fn DrawCylinderWires(position: Vector3, radiusTop: f32, radiusBottom: f32, height: f32, sides: c_int, color: Color) void;
...
pub extern fn DrawBillboardRec(camera: Camera, texture: Texture2D, rec: Rectangle, position: Vector3, size: Vector2, tint: Color) void;
pub extern fn DrawBillboardPro(camera: Camera, texture: Texture2D, rec: Rectangle, position: Vector3, up: Vector3, size: Vector2, origin: Vector2, rotation: f32, tint: Color) void;
...
pub const __UINTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `ULL`"); // <builtin>:164:9
...
pub const __INT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `LL`"); // <builtin>:190:9
...
pub const __UINT32_FMTX__ = "X";
pub const __UINT32_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `U`"); // <builtin>:215:9
...
pub const __UINT64_FMTX__ = "llX";
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `ULL`"); // <builtin>:224:9
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // D:\Gonza\Zig\zig-x86_64-windows-0.16.0\lib\compiler\aro\include\stdarg.h:12:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // D:\Gonza\Zig\zig-x86_64-windows-0.16.0\lib\compiler\aro\include\stdarg.h:14:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // D:\Gonza\Zig\zig-x86_64-windows-0.16.0\lib\compiler\aro\include\stdarg.h:15:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // D:\Gonza\Zig\zig-x86_64-windows-0.16.0\lib\compiler\aro\include\stdarg.h:18:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // D:\Gonza\Zig\zig-x86_64-windows-0.16.0\lib\compiler\aro\include\stdarg.h:22:9
...
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // .zig-cache\o\3f0ed612782353b0ddff0cd2c791a782\raylib.h:132:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // .zig-cache\o\3f0ed612782353b0ddff0cd2c791a782\raylib.h:135:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // .zig-cache\o\3f0ed612782353b0ddff0cd2c791a782\raylib.h:138:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // .zig-cache\o\3f0ed612782353b0ddff0cd2c791a782\raylib.h:141:13
